...
def main(args):
    ...
    data_file = "H1JetsAtHighQ2HERAII_IncJetsQ2Pt_unfolding_raw.txt"
    ...
    np.savetxt("H1JetsAtHighQ2HERAII_IncJetsQ2Pt_unfolding_prep.txt", res, header=header, fmt='%12.5g')
